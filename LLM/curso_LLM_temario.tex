...
\begin{tcolorbox}[colback=neutralcolor!10, colframe=primarycolor, arc=2mm, boxrule=0.5pt, left=5pt, right=5pt, top=5pt, bottom=5pt]
    ...
    \textbf{Profesor:} Francisco Pérez Carbajal\\
    \textbf{Ayudante:} José Eduardo Rodríguez Barrios
\end{tcolorbox}
\end{center}
\end{titlepage}
...
\begin{itemize}[leftmargin=*]
    ...
    \item Configuración del entorno de desarrollo (Python + Hugging Face).
...
\begin{itemize}[leftmargin=*]
    ...
    \item Uso de herramientas de MLOps para el seguimiento de experimentos.
\end{itemize}
